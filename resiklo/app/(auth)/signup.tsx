        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
            <SafeAreaView className="m-auto flex flex-col items-center justify-start gap-5">
                <View className='flex flex-col items-center gap-2'>
                    <Text className="text-gray font-montserrat-bold text-4xl">
                        Sign Up to Resiklo
                    </Text>
                    <Text className='text-gray-400'>let's create your account!</Text>
                </View>
                <Pressable className="w-80 bg-blue-600 p-3 rounded-full items-center flex-row justify-center gap-3 bg-facebook active:scale-105 shadow-lg">
                    <Image
                        source={require('@/assets/images/facebook_logo_square.png')}
                        style={{ width: 20, height: 20 }}
                    />
                    <Text className="text-white text-center text-lg font-montserrat-medium">SIGN UP WITH FACEBOOK</Text>
                </Pressable>
                <Divider></Divider>
                ...
                <View className="flex flex-col gap-3">
                    ...
                    <View className="flex flex-row gap-2">
                        <View>
                            ...
                            <View className='min-h-[20px]'>
                                {errors.firstName ? <Text className="mt-2 text-red-500 ">{errors.firstName.message}</Text> : null}
                            </View>
                        </View>
                    ...
                    <Animated.View style={animatedStyle}>
                        <Pressable
                            ...
                            className="self-center rounded-full bg-darthmouth p-3 shadow-lg w-[90%]"
                        >
                            <Text className="font-montserrat-semi-bold text-xl self-center text-white">CONTINUE</Text>
                        </Pressable>
                    </Animated.View>

                    <View className='flex flex-row items-center justify-center gap-2'>
                        <Text className="self-center font-roboto-medium">
                            Already have an account?
                        </Text>
                        <Link href={'/(auth)/login'}>
                            <Text className="font-bold font-roboto-medium text-darthmouth underline">
                                LOGIN
                            </Text>
                        </Link>
                    </View>
