  ...
  return (
    <SafeAreaView>
      <View style={{ alignItems: 'center' }}>
        <Text className="mt-2 font-montserrat-semi-bold text-xl text-black">Save Activity</Text>
      </View>
      ...
      <View className="flex w-full flex-col items-center justify-center gap-3 rounded-lg p-4">
        ...
        >
          ...
          {images.map((img, index) => (
            <View key={index} style={{ marginRight: 10 }}>
              <Image source={{ uri: img }} style={{ width: 150, height: 150, borderRadius: 10 }} />
            </View>
          ))}
        ...
        {/* Submit  */}
        <Pressable onPressIn={() => router.replace('/')} className="overflow-hidden rounded-full">
          <LinearGradient
